...
**Platform: [OffSec](https://portal.offsec.com/courses/pen-103-16306/overview)**
...
- Useful Commands
    ...
    - Managing Processes
    - Managing Rights
    - Getting System Inforamtion and Logs
    - Discovering the Hardware


**Lesson Summary (From the Site):**
```
...
**Notes:**
> It has now been 19 days since the last log. So, what happened was my laptop keyboard suddenly broke when I restarted, some keys were not responding and I needed On-Screen Keyboard just to login to the PC. This morning, I went and got it checked and it needed to be replaced, the keyboard and the screen (since this was flashing and broken too), but it costs so much just to get it replaced so I just bought an external keyboard :D. It is now working great, aside from the flashing/ghosting screen so I can now go back to learning, finally!

> Today, I'm gonna be going to the next step which is learning the Linux Fundamentals on [this site](https://portal.offsec.com/courses/pen-103-16306/overview).

> I feel like I don't really understand the stuff I read lol but still I'm just gonna read them and wait for the exciting parts of the lesson.

> Damn these are confusing, it's too much to learn tight now, hopefully the important parts are repeated in the next lessons.

> Read all and did all exercises, the exercises didn't have explanation so I just followed the solutions and shit. I think this requires Linux Command basic knowledge first but oh well, it'll work out. I hope...
